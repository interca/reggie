...
public class SystemJsonResponse extends LinkedHashMap<String,Object> {
    ...
    public SystemJsonResponse (int code,String message,Object data){
         ...
         if(message!=null)this.put(RESULT_MESSAGE,message);
         if(data!=null)this.put(RESULT_DATA,data);
    }
    ...
    public  static SystemJsonResponse success(){
      return new SystemJsonResponse(GlobalResponseCode.OPERATE_SUCCESS.getCode(),
    ...
    public static  SystemJsonResponse fail(){
        return new SystemJsonResponse(GlobalResponseCode.OPERATE_FAIL.getCode(),
                                      GlobalResponseCode.OPERATE_FAIL.getMessage());
    }
